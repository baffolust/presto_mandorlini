<nav class="navbar navbar-expand-lg background-custom-tertiary text-custom-secondary shadow">
    <div class="container-fluid">
        ...
        <form class="d-flex position-absolute start-50 form-search-custom translate-middle-x" role="search"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                @auth
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="{{ route('article.create') }}">{{ __('ui.Insert_Article') }}</a>
                    </li>
                @endauth
                            ...
                            @if (!Auth::user()->is_revisor)
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ route('revisor.become-revisor') }}">{{ __('ui.Become_Revisor') }}</a>
                                </li>
                            @endif
                            <li>
                                <hr class="dropdown-divider">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-3">
                ...
                @guest
                    <li class="nav-item me-md-1">
                        <a class="btn background-custom-primary text-custom-secondary"
